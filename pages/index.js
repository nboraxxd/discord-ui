  ...
  return (
    <div className="flex h-screen text-gray-100">
      ...
      <div className="flex w-60 flex-col bg-gray-800">
        <div className="font-title flex h-12 items-center px-3 text-white shadow-md">Tailwind CSS</div>
        <div className="scrollbar flex-1 space-y-2 overflow-y-scroll p-3 text-gray-300 font-medium">
